...
class ControllerPaymentFrotel extends Controller
{
    ...
    public function index()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/frotel.tpl')) {
            $template = $this->config->get('config_template') . '/template/payment/frotel.tpl';
        } else {
            $template = 'default/template/payment/frotel.tpl';
        }
    ...
    public function confirm()
    {
        ...
        try {
            ...
            if (isset($result['factor']['banks'])) {
                $url = $this->url->link('payment/frotel/pay');
                // clear cart
                $this->cart->clear();
            }
    ...
    public function pay()
    {
        ...
        $data['url'] = $this->url->link('payment/frotel/gateway');

        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/frotel_pay.tpl')) {
            $template = $this->config->get('config_template') . '/template/payment/frotel_pay.tpl';
        } else {
            $template = 'default/template/payment/frotel_pay.tpl';
        }
    ...
    public function gateway()
    {
        ...
        $callback = $this->url->link('payment/frotel/callback','id='.$orderId.'&factor='.$frotel_factor);
    ...
    public function callback()
    {
        ...
        $this->response->redirect($this->url->link('payment/frotel/pay'));
    }
    ...
    public function city()
    {
        ...
        $data['url'] = $this->url->link('payment/frotel/city');
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/frotel_city.tpl')) {
            $template = $this->config->get('config_template') . '/template/payment/frotel_city.tpl';
        } else {
            $template = 'default/template/payment/frotel_city.tpl';
        }
